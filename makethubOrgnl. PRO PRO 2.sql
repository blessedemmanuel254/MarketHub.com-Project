...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 04, 2026 at 02:15 PM
...
(34, 'Stanely MUG', 1300.00, 'KES', 'Ideal for travel and outdoor use and it\'s easy to clean.', 'Home Items', 'uploads/company_products/prod_69ccf8e16f04a2.67801133.webp', NULL, 1, '2026-04-01 10:52:17', '1da8ded9b14b02d393a6fca0c8a7c62a', '0101000011110000101010001010100010100000101011001100110010000100', 22, '2026-04-02 14:13:55'),
(30, '6 Litre Electric Pressure Cooker', 5200.00, 'KES', 'Energy efficient performance. Easy to clean design. Ideal for family meals', 'Home Items', 'uploads/company_products/prod_69c94ee0bbc083.85638684.webp', NULL, 0, '2026-03-29 16:10:09', '759957fb777f833d5a0b3f3f94370d38', '0101000011110000110010001100100011000000111001001100110010000100', 24, '2026-04-01 08:18:23');
...
(2, 17, 'Juice', 'Food & Snacks', 60.00, 36, 'uploads/products/product_69ce08113fe1d8.66003342.webp', '306c060f642f661d508f4f9f86d4d364', 700, 519, 55, 'webp', 'active', '2026-02-25 22:52:53', '2026-04-04 12:13:19', '00000010000011000001100001110110'),
(3, 17, 'Githeri', 'Food & Snacks', 100.00, 17, 'uploads/products/product_69ce0643920929.02512567.webp', '3cc341a7c025694fc566ac521537ca37', 700, 700, 40, 'webp', 'active', '2026-02-25 22:54:35', '2026-04-04 12:01:04', '00001111001000110110000101110001'),
...
(9, 15, 'Passion Juice3', 'Food & Snacks', 600.00, 47, 'uploads/products/product_69cd3cf11d9a38.85948077.webp', 'b308caf21abeb85d8acc179d77a28ad5', 700, 393, 40, 'webp', 'active', '2026-04-01 15:42:41', '2026-04-04 07:07:44', '11001101011010100110101101100110'),
...
(11, 29, 'sales', 1406771.00, 0.00, '2026-03-24 01:39:24', '2026-04-03 17:50:40'),
...
(48, 15, 'seller', 0.00, 0.00, '2026-04-03 21:13:25', '2026-04-03 21:13:25'),
...
(53, 17, 'seller', 410.00, 410.00, '2026-04-04 12:07:27', '2026-04-04 12:13:19'),
...
--
ALTER TABLE `financial_transactions`
  MODIFY `transaction_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
...
--
ALTER TABLE `wallets`
  MODIFY `wallet_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;

--
-- AUTO_INCREMENT for table `withdrawals`
--
ALTER TABLE `withdrawals`
  MODIFY `withdrawal_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;

--
-- AUTO_INCREMENT for table `withdrawal_logs`
--
ALTER TABLE `withdrawal_logs`
  MODIFY `log_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
